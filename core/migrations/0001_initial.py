# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-01-30 23:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_vinculo', models.CharField(choices=[('1', 'Servidor Público - Professor'), ('2', 'Servidor Público ou Empregado Público'), ('3', 'Colaborador sem vínculo com o serviço')], default='1', max_length=1, verbose_name='Tipo de Vínculo')),
                ...
                ('uf', models.CharField(choices=[('AC', 'AC - Acre'), ('AL', 'AL - Alagoas'), ('AP', 'AP - Amapá'), ('AM', 'AM - Amazonas'), ('BA', 'BA - Bahia'), ('CE', 'CE - Ceará'), ('DF', 'DF - Distrito Federal'), ('ES', 'ES - Espírito Santo'), ('GO', 'GO - Goiás'), ('MA', 'MA - Maranhão'), ('MT', 'MT - Mato Grosso'), ('MS', 'MS - Mato Grosso do Sul'), ('MG', 'MG - Minas Gerais'), ('PA', 'PA - Pará'), ('PB', 'PB - Paraíba'), ('PR', 'PR - Paraná'), ('PE', 'PE - Pernambuco'), ('PI', 'PI - Piauí'), ('RJ', 'RJ - Rio de Janeiro'), ('RN', 'RN - Rio Grande do Norte'), ('RS', 'RS - Rio Grande do Sul'), ('RO', 'RO - Rondônia'), ('RR', 'RR - Roraima'), ('SC', 'SC - Santa Catarina'), ('SP', 'SP - São Paulo'), ('SE', 'SE - Sergipe'), ('TO', 'TO - Tocantins')], default='1', max_length=2, verbose_name='UF')),
                ...
                ('tipo_conta', models.CharField(choices=[('1', 'Conta-salário'), ('2', 'Conta-poupança'), ('3', 'Conta-corrente')], default='1', max_length=1, verbose_name='Tipo de Conta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('no_cargo', models.CharField(max_length=6, unique=True, verbose_name='Nome')),
                ('ic_ativo', models.BooleanField(verbose_name='Ativo')),
            ],
        ),
        migrations.CreateModel(
